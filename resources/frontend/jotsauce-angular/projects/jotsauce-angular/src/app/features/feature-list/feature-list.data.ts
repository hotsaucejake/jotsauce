...
export const features: Feature[] = [
  {
    ...
    description: 'jot.features.angular',
  ...
  },
  {
    ...
    description: 'jot.features.angular-material',
  ...
  },
  {
    ...
    description: 'jot.features.angular-cli',
  ...
  },
  {
    ...
    description: 'jot.features.bootstrap',
  ...
  },
  {
    ...
    description: 'jot.features.typescript',
  ...
  },
  {
    ...
    description: 'jot.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'jot.features.fontawesome',
  ...
  },
  {
    ...
    description: 'jot.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'jot.features.themes.title',
    description: 'jot.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'jot.features.lazyloading.title',
    description: 'jot.features.lazyloading.description',
    documentation:
